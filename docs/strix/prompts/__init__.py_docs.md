# Documentation: strix/prompts/__init__.py

## File Metadata
- **Path**: `strix/prompts/__init__.py`
- **Size**: 3490 bytes
- **Extension**: `.py`
- **Lines**: 109
...
This file is located at `strix/prompts/__init__.py` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.193118*
