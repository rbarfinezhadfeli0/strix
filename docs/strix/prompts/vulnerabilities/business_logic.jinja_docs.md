# Documentation: strix/prompts/vulnerabilities/business_logic.jinja

## File Metadata
- **Path**: `strix/prompts/vulnerabilities/business_logic.jinja`
- **Size**: 9857 bytes
- **Extension**: `.jinja`
- **Lines**: 171
...
This file is located at `strix/prompts/vulnerabilities/business_logic.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.234817*
