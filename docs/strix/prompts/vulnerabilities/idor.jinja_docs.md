# Documentation: strix/prompts/vulnerabilities/idor.jinja

## File Metadata
- **Path**: `strix/prompts/vulnerabilities/idor.jinja`
- **Size**: 10785 bytes
- **Extension**: `.jinja`
- **Lines**: 195
...
This file is located at `strix/prompts/vulnerabilities/idor.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.221849*
