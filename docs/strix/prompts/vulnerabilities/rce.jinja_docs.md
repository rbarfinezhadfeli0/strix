# Documentation: strix/prompts/vulnerabilities/rce.jinja

## File Metadata
- **Path**: `strix/prompts/vulnerabilities/rce.jinja`
- **Size**: 8425 bytes
- **Extension**: `.jinja`
- **Lines**: 154
...
This file is located at `strix/prompts/vulnerabilities/rce.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.243027*
