# Documentation: strix/prompts/vulnerabilities/xss.jinja

## File Metadata
- **Path**: `strix/prompts/vulnerabilities/xss.jinja`
- **Size**: 8675 bytes
- **Extension**: `.jinja`
- **Lines**: 169
...
This file is located at `strix/prompts/vulnerabilities/xss.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.224463*
