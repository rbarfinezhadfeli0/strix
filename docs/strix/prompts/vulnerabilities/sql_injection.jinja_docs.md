# Documentation: strix/prompts/vulnerabilities/sql_injection.jinja

## File Metadata
- **Path**: `strix/prompts/vulnerabilities/sql_injection.jinja`
- **Size**: 8426 bytes
- **Extension**: `.jinja`
- **Lines**: 151
...
This file is located at `strix/prompts/vulnerabilities/sql_injection.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.227062*
