# Documentation: strix/prompts/vulnerabilities/broken_function_level_authorization.jinja

## File Metadata
- **Path**: `strix/prompts/vulnerabilities/broken_function_level_authorization.jinja`
- **Size**: 7204 bytes
- **Extension**: `.jinja`
- **Lines**: 146
...
This file is located at `strix/prompts/vulnerabilities/broken_function_level_authorization.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.251512*
