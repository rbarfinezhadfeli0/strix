# Documentation: strix/prompts/vulnerabilities/csrf.jinja

## File Metadata
- **Path**: `strix/prompts/vulnerabilities/csrf.jinja`
- **Size**: 8739 bytes
- **Extension**: `.jinja`
- **Lines**: 174
...
This file is located at `strix/prompts/vulnerabilities/csrf.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.237691*
