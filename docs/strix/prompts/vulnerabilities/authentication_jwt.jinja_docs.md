# Documentation: strix/prompts/vulnerabilities/authentication_jwt.jinja

## File Metadata
- **Path**: `strix/prompts/vulnerabilities/authentication_jwt.jinja`
- **Size**: 8388 bytes
- **Extension**: `.jinja`
- **Lines**: 147
...
This file is located at `strix/prompts/vulnerabilities/authentication_jwt.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.216209*
