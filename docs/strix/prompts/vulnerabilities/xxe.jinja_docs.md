# Documentation: strix/prompts/vulnerabilities/xxe.jinja

## File Metadata
- **Path**: `strix/prompts/vulnerabilities/xxe.jinja`
- **Size**: 7841 bytes
- **Extension**: `.jinja`
- **Lines**: 184
...
This file is located at `strix/prompts/vulnerabilities/xxe.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.248948*
