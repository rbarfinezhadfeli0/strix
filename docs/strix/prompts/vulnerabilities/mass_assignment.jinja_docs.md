# Documentation: strix/prompts/vulnerabilities/mass_assignment.jinja

## File Metadata
- **Path**: `strix/prompts/vulnerabilities/mass_assignment.jinja`
- **Size**: 7176 bytes
- **Extension**: `.jinja`
- **Lines**: 141
...
This file is located at `strix/prompts/vulnerabilities/mass_assignment.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.219068*
