# Documentation: strix/prompts/vulnerabilities/ssrf.jinja

## File Metadata
- **Path**: `strix/prompts/vulnerabilities/ssrf.jinja`
- **Size**: 7899 bytes
- **Extension**: `.jinja`
- **Lines**: 135
...
This file is located at `strix/prompts/vulnerabilities/ssrf.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.229446*
