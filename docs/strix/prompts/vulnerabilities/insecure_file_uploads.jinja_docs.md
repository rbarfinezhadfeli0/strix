# Documentation: strix/prompts/vulnerabilities/insecure_file_uploads.jinja

## File Metadata
- **Path**: `strix/prompts/vulnerabilities/insecure_file_uploads.jinja`
- **Size**: 10972 bytes
- **Extension**: `.jinja`
- **Lines**: 188
...
This file is located at `strix/prompts/vulnerabilities/insecure_file_uploads.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.246007*
