# Documentation: strix/prompts/vulnerabilities/path_traversal_lfi_rfi.jinja

## File Metadata
- **Path**: `strix/prompts/vulnerabilities/path_traversal_lfi_rfi.jinja`
- **Size**: 7916 bytes
- **Extension**: `.jinja`
- **Lines**: 142
...
This file is located at `strix/prompts/vulnerabilities/path_traversal_lfi_rfi.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.240391*
