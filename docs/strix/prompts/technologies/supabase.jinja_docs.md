# Documentation: strix/prompts/technologies/supabase.jinja

## File Metadata
- **Path**: `strix/prompts/technologies/supabase.jinja`
- **Size**: 11751 bytes
- **Extension**: `.jinja`
- **Lines**: 189
...
This file is located at `strix/prompts/technologies/supabase.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.206436*
