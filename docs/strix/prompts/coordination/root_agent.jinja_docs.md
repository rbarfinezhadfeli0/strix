# Documentation: strix/prompts/coordination/root_agent.jinja

## File Metadata
- **Path**: `strix/prompts/coordination/root_agent.jinja`
- **Size**: 1996 bytes
- **Extension**: `.jinja`
- **Lines**: 41
...
This file is located at `strix/prompts/coordination/root_agent.jinja` and is part of the Strix security testing framework.
...
*Date: 2025-11-15T13:53:00.200809*
