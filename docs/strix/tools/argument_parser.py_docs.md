# Documentation: strix/tools/argument_parser.py
...
This file is located at `strix/tools/argument_parser.py` and is part of the Strix security testing framework.

### Python File Analysis

#### Classes

- **ArgumentConversionError** (inherits from: Exception)
...
*Date: 2025-11-15T13:53:00.264540*
