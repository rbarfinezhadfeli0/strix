# Documentation: strix/tools/proxy/proxy_manager.py
...
This file is located at `strix/tools/proxy/proxy_manager.py` and is part of the Strix security testing framework.
...
- **__init__**(self, auth_token: str | None = None)
...
Found 8 docstring(s) in this file.
...
*Date: 2025-11-15T13:53:00.275664*
