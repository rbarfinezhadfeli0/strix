# Documentation: strix/tools/terminal/terminal_session.py
...
This file is located at `strix/tools/terminal/terminal_session.py` and is part of the Strix security testing framework.

### Python File Analysis

#### Classes

- **BashCommandStatus** (inherits from: Enum)
- **TerminalSession**
...
*Date: 2025-11-15T13:53:00.347991*
