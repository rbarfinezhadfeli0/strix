# Documentation: strix/tools/registry.py
...
This file is located at `strix/tools/registry.py` and is part of the Strix security testing framework.

### Python File Analysis

#### Classes

- **ImplementedInClientSideOnlyError** (inherits from: Exception)
...
*Date: 2025-11-15T13:53:00.266649*
