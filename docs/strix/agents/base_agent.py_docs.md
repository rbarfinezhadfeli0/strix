# Documentation: strix/agents/base_agent.py
...
This file is located at `strix/agents/base_agent.py` and is part of the Strix security testing framework.

### Python File Analysis

#### Classes

- **AgentMeta** (inherits from: type)
- **BaseAgent** (inherits from: metaclass=AgentMeta)
...
Found 2 docstring(s) in this file.
...
*Date: 2025-11-15T13:53:00.099380*
