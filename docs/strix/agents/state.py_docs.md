# Documentation: strix/agents/state.py
...
This file is located at `strix/agents/state.py` and is part of the Strix security testing framework.

### Python File Analysis

#### Classes

- **AgentState** (inherits from: BaseModel)
...
*Date: 2025-11-15T13:53:00.102350*
