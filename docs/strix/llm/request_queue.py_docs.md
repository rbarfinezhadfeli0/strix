# Documentation: strix/llm/request_queue.py

## File Metadata
- **Path**: `strix/llm/request_queue.py`
- **Size**: 2595 bytes
- **Extension**: `.py`
- **Lines**: 78
...
This file is located at `strix/llm/request_queue.py` and is part of the Strix security testing framework.
...
- **__init__**(self, max_concurrent: int = 6, delay_between_requests: float = 1.0)
...
*Date: 2025-11-15T13:53:00.132546*
