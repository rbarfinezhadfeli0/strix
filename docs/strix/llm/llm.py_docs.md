# Documentation: strix/llm/llm.py
...
This file is located at `strix/llm/llm.py` and is part of the Strix security testing framework.

### Python File Analysis

#### Classes

- **LLMRequestFailedError** (inherits from: Exception)
- **StepRole** (inherits from: str, Enum)
- **LLMResponse**
- **RequestStats**
- **LLM**
...
- **__init__**(self, message: str, details: str | None = None)
...
*Date: 2025-11-15T13:53:00.128383*
