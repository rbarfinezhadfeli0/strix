# Documentation: strix/telemetry/tracer.py
...
This file is located at `strix/telemetry/tracer.py` and is part of the Strix security testing framework.
...
- **__init__**(self, run_name: str | None = None)
...
*Date: 2025-11-15T13:53:00.254718*
