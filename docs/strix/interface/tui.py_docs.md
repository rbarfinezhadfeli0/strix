# Documentation: strix/interface/tui.py
...
This file is located at `strix/interface/tui.py` and is part of the Strix security testing framework.

### Python File Analysis

#### Classes

- **ChatTextArea** (inherits from: TextArea)
- **SplashScreen** (inherits from: Static)
- **HelpScreen** (inherits from: ModalScreen)
- **StopAgentScreen** (inherits from: ModalScreen)
- **QuitScreen** (inherits from: ModalScreen)
- **StrixTUIApp** (inherits from: App)

#### Functions/Methods

- **__init__**(self, agent_name: str, agent_id: str)
...
*Date: 2025-11-15T13:53:00.146452*
