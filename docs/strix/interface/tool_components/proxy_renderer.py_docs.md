# Documentation: strix/interface/tool_components/proxy_renderer.py
...
This file is located at `strix/interface/tool_components/proxy_renderer.py` and is part of the Strix security testing framework.

### Python File Analysis

#### Classes

- **ListRequestsRenderer** (inherits from: BaseToolRenderer)
- **ViewRequestRenderer** (inherits from: BaseToolRenderer)
- **SendRequestRenderer** (inherits from: BaseToolRenderer)
- **RepeatRequestRenderer** (inherits from: BaseToolRenderer)
- **ScopeRulesRenderer** (inherits from: BaseToolRenderer)
- **ListSitemapRenderer** (inherits from: BaseToolRenderer)
- **ViewSitemapEntryRenderer** (inherits from: BaseToolRenderer)
...
*Date: 2025-11-15T13:53:00.180477*
