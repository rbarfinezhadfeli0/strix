# Documentation: strix/interface/tool_components/agents_graph_renderer.py
...
This file is located at `strix/interface/tool_components/agents_graph_renderer.py` and is part of the Strix security testing framework.

### Python File Analysis

#### Classes

- **ViewAgentGraphRenderer** (inherits from: BaseToolRenderer)
- **CreateAgentRenderer** (inherits from: BaseToolRenderer)
- **SendMessageToAgentRenderer** (inherits from: BaseToolRenderer)
- **AgentFinishRenderer** (inherits from: BaseToolRenderer)
- **WaitForMessageRenderer** (inherits from: BaseToolRenderer)
...
*Date: 2025-11-15T13:53:00.157098*
