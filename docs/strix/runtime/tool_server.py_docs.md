# Documentation: strix/runtime/tool_server.py
...
This file is located at `strix/runtime/tool_server.py` and is part of the Strix security testing framework.

### Python File Analysis

#### Classes

- **ToolExecutionRequest** (inherits from: BaseModel)
- **ToolExecutionResponse** (inherits from: BaseModel)
...
*Date: 2025-11-15T13:53:00.116348*
