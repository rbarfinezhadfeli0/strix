# Documentation: containers/Dockerfile
...
This file is located at `containers/Dockerfile` and is part of the Strix security testing framework.

### File Type
Generic text file with extension ``.
...
*Date: 2025-11-15T13:53:00.357746*
